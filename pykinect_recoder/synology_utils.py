...
def upload(args: argparse.ArgumentParser):
    try:
        f1 = filestation.FileStation(
            args.Synology_Ip, args.Synology_Port, args.Username, args.Password,
            args.secure, args.cert_verify, args.dsm_version, args.debug, args.otp_code 
        )
...
if __name__== "__main__":
    ...
    ## Synology nas 
    parser.add_argument("--Synology_Ip", type=str, default="hnvlab.synology.me", help="Set Ip address such as xxx.synology.me or 111.111.1.1")
    ...
    parser.add_argument("--cert_verify", type=bool, default=True, help="Set True if you want to verify your certificate")
    parser.add_argument("--dsm_version", type=int, default=7)
    parser.add_argument("--debug", type=bool, default=True)
    parser.add_argument("--otp_code", type=str, default=None)

    parser.add_argument("--dest_path", type=str, default="/dataset/test", help="Destination path in synology nas")
