...
def k4a_device_get_capture(
    ...
    capture_handle: ctypes.POINTER(k4a_capture_t), 
...
def k4a_device_get_imu_sample(
    device_handle: k4a_device_t, 
    imu_sample_handle: ctypes.POINTER(k4a_imu_sample_t), 
    timeout: ctypes.c_int32
) -> ctypes.c_int:
    """
    Reads an IMU sample.
...
def k4a_device_start_cameras(
    device_handle: k4a_device_t, 
    config: ctypes.POINTER(k4a_device_configuration_t)
) -> k4a_result_t:
    """
...
def k4a_device_get_serialnum(
    ...
    serial_number_size: ctypes.POINTER(ctypes.c_size_t)
) -> k4a_buffer_result_t:
    """
...
def k4a_device_get_version(
    device_handle: k4a_device_t, 
    hardware_version: ctypes.POINTER(k4a_hardware_version_t)
) -> k4a_result_t:
    """
