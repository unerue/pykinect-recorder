...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        self.layout_main.addWidget(self.label_x)
        self.layout_main.addWidget(self.label_y)
        self.layout_main.addWidget(self.label_z)
    ...
    def _change_x(self, buffer):
        self.label_x.setText(str(buffer))
    ...
    def _change_y(self, buffer):
        self.label_y.setText(str(buffer))
        # available_samples = 500
        # start = 0
        # if (available_samples < SAMPLE_COUNT):
        #     start = SAMPLE_COUNT - available_samples
    ...
    def _change_z(self, buffer):
        self.label_z.setText(str(buffer))
        # available_samples = 500
        # start = 0
        # if (available_samples < SAMPLE_COUNT):
        #     start = SAMPLE_COUNT - available_samples
